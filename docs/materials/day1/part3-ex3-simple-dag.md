...
``` console
%UCL_PROMPT_SHORT% <strong>condor_submit_dag simple.dag</strong>
-----------------------------------------------------------------------
...
``` console
%UCL_PROMPT_SHORT% <strong>watch -n 10 condor_q -nobatch</strong>
...
``` console
%UCL_PROMPT_SHORT% <strong>tail -f --lines=500 simple.dag.dagman.out</strong>
...
``` console
%UCL_PROMPT_SHORT% <strong>cat simple.log</strong>
