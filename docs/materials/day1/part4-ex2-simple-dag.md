...
``` console
user@learn $ <strong>condor_submit_dag simple.dag</strong>
-----------------------------------------------------------------------
...
``` console
user@learn $ <strong>watch -n 10 condor_q -nobatch</strong>
...
``` console
user@learn $ <strong>tail -f --lines=500 simple.dag.dagman.out</strong>
...
``` console
user@learn $ <strong>cat simple.log</strong>
...
``` console
user@learn $ <strong>rm simple.dag.*</strong>
```
